...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $cultureElements[0]; ?>" lang="<?php echo $cultureElements[0]; ?>">
    ...
    <head>
        ...
        <link href="<?php echo theme_path('css/jquery/easy-autocomplete.themes.min.css')?>" rel="stylesheet" type="text/css"/>
        <link href="<?php echo theme_path('css/jquery/easy-autocomplete.min.css')?>" rel="stylesheet"  type="text/css" />
        <link href="<?php echo theme_path('css/jquery/easy-autocomplete.css')?>" rel="stylesheet" type="text/css"/>
        ...
        echo javascript_include_tag('jquery/jquery.easy-autocomplete.js');
