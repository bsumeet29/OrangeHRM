$(document).ready(function() {
   empId=$('#systemUser_employeeName_empId').val();
   
   $('#systemUser_employeeName_empName').focusout(function(){
       empId=$('#systemUser_employeeName_empId').val();
...
$.validator.addMethod("checkUsernameForEmployee", function(value, element) {
       var responseReturn;
       var data = 'empId='+ empId+'&user_id='+userId;
       $.ajax({
                url: isUniqueUserUrl,
                data: data,
                async:false,
...
}, 'Username for employee already exists.');
...
//                checkUsernameForEmployee:true
            }
        },
        messages: {
            'systemUser[userName]' : {
                required: user_UserNameRequired,
                email:"Username is not valid format. Ex.admin@admin.com",      
...
//                checkUsernameForEmployee:'Username for employee already exists.'
            }
        }
