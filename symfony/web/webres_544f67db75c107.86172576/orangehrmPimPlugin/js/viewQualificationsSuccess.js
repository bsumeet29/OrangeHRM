...
$(document).ready(function() {
    ...
    var today = new Date();
    var event_date = new Date( $('#experience_to_date').val() );
    if( event_date <= today ){ return true;}else{return false;}
    }, "To date less than or equal to todays date.");
    ...
    $('form#frmDelWorkExperience table a.edit').live('click', function(event) {
        ...
        $('#experience_last_appraisal_date').val($("#last_apprisal_" + seqno).val());
        $('#experience_previous_ctc').val($("#ctc_previous_" + seqno).val());
        $('#experience_relevant_exp').val($("#relevant_experience_" + seqno).val());
        $('#experience_total_exp').val($("#total_experience_" + seqno).val());
        ...
        if ($("#experience_last_appraisal_date").val() == '') {
            $("#experience_last_appraisal_date").val(displayDateFormat);
        }
