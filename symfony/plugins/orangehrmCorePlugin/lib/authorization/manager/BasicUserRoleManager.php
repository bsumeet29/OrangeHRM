...
class BasicUserRoleManager extends AbstractUserRoleManager {
    ...
    protected function isSupervisorFor($empNumber) {
       ...
       /* if (is_null($this->subordinates)) {
        ...
        {    
            if(is_null($this->subSubordinate)){
            $this->subSubordinate = $this->getEmployeeService()->getSubordinateIdListBySupervisorId($subordinate);
            }
            if ((is_array($this->subordinates) && in_array($empNumber, $this->subordinates))||(is_array($this->subSubordinate)&& in_array($empNumber,$this->subSubordinate))){
                return true;
            }
        }
