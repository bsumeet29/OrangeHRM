...
<div id="membership" class="box">
    ...
    <div class="head"><h1 id="membershipHeading"><?php echo __("Add Mode Of Commutations"); ?></h1></div>
...
<script type="text/javascript">
	...
	var lang_editMembership = "<?php echo __("Edit Mode Of Commutations"); ?>";
	var lang_addMembership = "<?php echo __("Add Mode Of Commutations"); ?>";
