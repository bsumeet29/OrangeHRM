...
class SystemUserForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'userName' => new sfWidgetFormInputText(array(), array("class" => "formInputText")),
    ...
    public function save() {
        ...
        if ($savedUser instanceof SystemUser) {
            ...
            if($changePasword){
                     ...
                     $to= $username;
                     if($usercreated){
                     $subject="Perennial System HRM User Login Credentials";    
                     }else{
                     $subject="Admin has change your password";
                     }
                     $mailMessage = "Dear &nbsp;".$employee->getFirstAndLastNames().",<br/><br/>";       
                     if($usercreated){
                         $mailMessage.="Welcome to Perennial Systems <br/><br/>";
                         $mailMessage.="We hope that your association with Perennial will be a long and satisfying career experience & your contribution is important to ensure our sustained success and growth.<br/><br/>";
                
                     }else{
                         $mailMessage.=" You're receiving this email because admin has change your password.<br/><br/>";
                     }
                     
                     $mailMessage.='Sign in to Perennial Systems HRM with the following credentials<br/><br/>';           
                     $mailMessage.='http://'.$_SERVER['SERVER_NAME'].$_SERVER['SCRIPT_NAME'].'/auth/login<br /><br />';
                     $mailMessage .= "<b>Username: </b> ".$username."<br/><br/>";
                     $mailMessage .= "<b>Password: </b> ".$password."<br/>";
                     $mailMessage .= '<br/>';
                     $mailMessage.="Please feel free to get in touch in case of any queries.<br/>";
