...
class SystemUserService extends BaseService{
    ...
    public function isExistingSystemUserByEmpId($empId,$userId){
        try {
           return  $this->getSystemUserDao()->isExistingSystemUserByEmpId( $empId , $userId);
        } catch (Exception $e) {
            throw new ServiceException($e->getMessage(),$e->getCode(),$e);
        }
    ...
    public function getEmpNumbers($ids){
        return $this->getSystemUserDao()->getEmpNumbers($ids);
    }
