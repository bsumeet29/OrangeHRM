...
<?php include_partial('overlapping_compoff', array('overlapCompoff' => $overlapCompoff, 'workshiftLengthExceeded' => $workshiftLengthExceeded));?>

<div class="box" id="assign-leave">
    <div class="head">
        <h1><?php echo __('Apply Comp-off') ?></h1>
    </div>
    <div class="inner" id="applyCompoff">
