...
<?php if($compOffListPermissions->canRead()){?>
...
<script type="text/javascript">
    ...
    var compOffRequestId = <?php echo $compOffRequestId; ?>;
    ...
    var lang_LeaveComments = '<?php echo __('Comp-off Comments'); ?>';
    var lang_LeaveRequestComments = '<?php echo __('Comp-off Request Comments'); ?>';
   ...
   function handleSaveButton() {
    ...
    if (selectedActions > 0) {
        document.frmList_ohrmListComponent.action = "<?php echo url_for('leave/changeCompOffStatus?id='.$compOffRequestId);?>"; 
