...
<div class="box toggableForm" id="leave-list-search">
    <div class="head">
        <h1><?php echo __('Comp-off Extension Request List');?></h1>
    </div>
    <div class="inner">
...
<div class="modal hide midsize" id="commentDialog">
  <div class="modal-header">
    ...
    <h3><?php echo __('Comp-off Request Comments'); ?></h3>
  </div>
  <div class="modal-body">
    <p>
    <form action="updateCompOffComment" method="post" id="frmCommentSave">
...
<script type="text/javascript">
    ...
    var commentUpdateUrl = '<?php echo public_path('index.php/leave/updateCompOffComment'); ?>';
    var getCommentsUrl = '<?php echo url_for('leave/getCompOffCommentsAjax'); ?>';
    ...
    var leave_status_pending = '<?php echo PluginCompOff::COMPOFF_STATUS_PENDING;?>';
    ...
    //changes by firoj
        ...
        $('#dialogDeleteBtn').click(function() {
            document.frmList_ohrmListComponent.action = "<?php echo url_for('leave/deleteCompOffHistory');?>";        
...
//        
    ...
    function handleSaveButton() {
        ...
        $('select[name^="select_request_action_"]').each(function() {
            var id = $(this).attr('id').replace('select_request_action_', '');
            if ($(this).val() == '') {
               ...
               console.log( $('#hdnLeaveRequest_' + id).val('WF' + $(this).val()));
            }
            /*if ($(this).val() == '') {
        ...
        if (selectedActions > 0) {
             document.frmList_ohrmListComponent.action = "<?php echo url_for('leave/changeExtensionRequestStatus');?>"; 
            document.frmList_ohrmListComponent.submit(); 
        } else {
