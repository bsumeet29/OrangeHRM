...
<div class="modal hide midsize" id="commentDialog">
  <div class="modal-header">
    ...
    <h3><?php echo __('WFH Request Comments'); ?></h3>
  </div>
...
<script type="text/javascript">
    ...
    //changes by firoj
        ...
        $('#dialogDeleteBtn').click(function() {
            document.frmList_ohrmListComponent.action = "<?php echo url_for('leave/deleteWfhHistory');?>";        
...
//        
    ...
    function handleSaveButton() {
        ...
        if (selectedActions > 0) {
             document.frmList_ohrmListComponent.action = "<?php echo url_for('leave/changeWfhStatus');?>"; 
            document.frmList_ohrmListComponent.submit(); 
        } else {
