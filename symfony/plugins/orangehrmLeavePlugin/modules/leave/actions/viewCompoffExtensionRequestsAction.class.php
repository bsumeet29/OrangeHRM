...
class viewCompoffExtensionRequestsAction extends baseLeaveAction {
    ...
    public function execute($request) {
        ...
        if($mode == 'default_list'){
                   $request->setParameter('initialActionName', 'viewCompoffExtensionRequests');
        }
        else{
...
//                    }
       ...
       // echo"<pre>";print_r($searchParams);exit;
        $result = $this->searchCompoffExtensionRequests($searchParams, $page);
        ...
        $this->baseUrl = $mode == CompOffListForm::MODE_MY_LEAVE_LIST ? 'leave/viewMyCompOffList' : 'leave/viewCompoffExtensionRequests';
...
//      
        $this->setTemplate('viewCompoffExtensionRequests');
    }

    protected function searchCompoffExtensionRequests(ParameterObject $searchParams, $page) {
        $result = $this->getCompOffRequestService()->searchCompoffExtensionRequests($searchParams, $page, false, false, true, true);
        return $result;
    }
...
//        print_r($compOffList);exit;
    ...
    protected function getListConfigurationFactory() {
        ...
        $configurationFactory = new ExtensionRequestListConfigurationFactory();
