        ...
        if ($request->isMethod('post')) {
            ...
            if ($this->form->isValid()) {
                ...
                $leaveEntitlement = $this->getLeaveEntitlement($this->form->getValues());
                 ...
                 $carryForward=$this->form->getValue('carryForward');
                ...
                if (!isset($bulkFilter['bulk_assign'])) {
                   ...
                   if(isset($carryForward)){
                       $forward=1;
                        $savedCount = $this->getLeaveEntitlementService()->bulkAssignLeaveEntitlements($employeeNumbers, $leaveEntitlement,$forward);
                   }else{
