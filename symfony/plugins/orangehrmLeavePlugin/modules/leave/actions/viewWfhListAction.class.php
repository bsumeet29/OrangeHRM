...
class viewWfhListAction extends baseLeaveAction {
    ...
    public function execute($request) {
        ...
        $this->form = $this->getWfhListForm($mode);
        $values = array();
...
//                    }
        ...
        $result = $this->searchWfhRequests($searchParams, $page);
        ...
        $this->baseUrl = $mode == WfhListForm::MODE_MY_LEAVE_LIST ? 'leave/viewMyWfhList' : 'leave/viewWfhList';
...
//      
        $this->setTemplate('viewWfhList');
    }

    protected function searchWfhRequests($searchParams, $page) {
        $result = $this->getWfhRequestService()->searchWfhRequests($searchParams, $page, false, false, true, true);
        return $result;
    }
...
//        print_r($compOffList);exit;
    ...
    protected function getListConfigurationFactory() {
        ...
        WfhListConfigurationFactory::setListMode($this->mode);
        WfhListConfigurationFactory::setLoggedInEmpNumber($loggedInEmpNumber);
        $configurationFactory = new WfhListConfigurationFactory();

        return $configurationFactory;
    }

    protected function getWfhListForm($mode) {
        $this->form = new WfhListForm($mode);
        return $this->form;
    }
