...
class viewLeaveEntitlementsAction extends sfAction {
    ...
    public function getCompOffRequestService(){
        if(is_null($this->compoffRequestService)) {
            ...
            $this->compoffRequestService->setCompoffRequestDao(new CompoffRequestDao());
        }
    ...
    public function execute($request) {        
        ...
        $this->extensionForm = new CompoffExtensionForm(array(),array(),true);
