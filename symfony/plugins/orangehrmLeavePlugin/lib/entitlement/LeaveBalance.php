...
class LeaveBalance {
    ...
    public $taken;
    public $adjustment ;
    public $conditional_approved;
    
    
    public function getConditional_approved() {
        return $this->conditional_approved;
    }

    public function setConditional_approved($conditional_approved) {
        $this->conditional_approved = $conditional_approved;
    }
    ...
    public function updateBalance() {
        $balance = $balance+(($this->entitled + $this->adjustment) - ( $this->scheduled + $this->taken + $this->conditional_approved));
