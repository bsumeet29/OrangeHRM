 ...
 */
class WfhListForm extends sfForm {
   ...
   /*     $widgets['calFromDate'] = new ohrmWidgetDatePicker(array(), array('id' => 'calFromDate'));
        ...
        */
        // Comp-off Statuses
        $leaveStatusChoices = self::getWfhStatusList();     
       /* if ($this->mode == self::MODE_MY_LEAVE_LIST) {
            $defaultStatuses = array_keys($leaveStatusChoices);
        } else {*/
            $defaultStatuses = array_keys(Wfh::getPendingWfhStatusList());
       // }
        ...
        $labels['chkSearchFilter'] = 'Show WFH with Status';
