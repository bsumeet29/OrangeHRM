...
class ohrmWidgetFormLeaveDuration extends sfWidgetForm {
    ...
    public function render($name, $value = null, $attributes = array(), $errors = array()) {
        ...
        $defaultDuration = $this->getOption('Select');
        ...
        $durationChoices = array('Select','null');
        ...
        $halfDayWidget = new sfWidgetFormSelect(array('choices' => array(self::HALF_DAY_AM => __('Session 1'), self::HALF_DAY_PM => __('Session 2'))), 
