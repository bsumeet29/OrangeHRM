...
class LeaveEntitlementAddForm extends LeaveEntitlementForm {
    ...
    public function configure() {
        ...
        $this->setWidget('carryForward', new sfWidgetFormInputCheckbox());
        $this->setValidator('carryForward', new sfValidatorPass(array('required' => false)));
    ...
    protected function getFormLabels() {
        ...
        $labels = array(
            'carryForward'=> __('Carry Forward Leave'),
    ...
    public function setEditMode() {
        ...
        $this->getWidget('carryForward')->setAttribute('disabled', 'disabled');
