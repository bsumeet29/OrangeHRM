 ...
 */
class ApplyWfhForm extends sfForm {
...
//        }           
    ...
    public function getJavaScripts() {
        ...
        $javaScripts[] = plugin_web_path('orangehrmLeavePlugin', 'js/applyWfhSuccess.js');
...
//            'txtLeaveType' => new sfValidatorChoice(array('choices' => $leaveTypeIds, 'required' => true)),
            ...
            'txtContact'=>new sfValidatorNumber(array('required' => false, 'trim' => true)),
