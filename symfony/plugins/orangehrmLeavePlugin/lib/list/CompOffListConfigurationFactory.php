 ...
 * Code by Rahul
 */
class CompOffListConfigurationFactory extends ohrmListConfigurationFactory {
    ...
    public function init() {
        ...
        $header1->populateFromArray(array(
            ...
            'elementProperty' => array(
                'labelGetter' => array('getCompOffDateRange'),
...
$compOffRequestService = new compOffRequestService();
       $header2->populateFromArray(array(
        ...
        $header5->populateFromArray(array(
            ...
            'textAlignmentStyle' => 'left',
            'elementProperty' => array(
                'labelGetter' => array('getcompOffBreakdown'),
                'placeholderGetters' => array('id' => 'getId'),
                'urlPattern' => public_path('index.php/leave/viewCompOffRequest/id/{id}'),
               'hasHiddenField' => true,
        ...
        $header6->populateFromArray(array(
            ...
            'textAlignmentStyle' => 'left',
            'elementProperty' => array(
                'getter' => 'getCompoffRequestComment',
        ...
        $header7->populateFromArray(array(
            ...
            'elementProperty' => array(
                ...
                'hideIfEmpty' => true,
                'options' => array( $compOffRequestService, 'getCompOffRequestActions', array(self::RECORD, self::$loggedInEmpNumber)),
