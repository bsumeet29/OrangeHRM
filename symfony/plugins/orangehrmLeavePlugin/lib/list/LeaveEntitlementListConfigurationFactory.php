...
class LeaveEntitlementListConfigurationFactory extends ohrmListConfigurationFactory {
    ...
    public function init() {
        ...
        $widthPercentages = self::$displayLeaveType ? array('20%', '25%', '20%', '20%','10%', '5%') :           
                array('45%', '25%', '25%', '5%');
        ...
        if (self::$displayLeaveType) {
            ...
            $leaveTypeHeader->populateFromArray(array(
                ...
                'elementProperty' => array('getter' => array('getLeaveType', 'getDescriptiveLeaveTypeName'),
                    'hasHiddenField' => true,
                'hiddenFieldName' => 'leaveEntitlement',
                'hiddenFieldId' => 'leaveEntitlement',
                'hiddenFieldValueGetter' => 'getId',
                 /* 'hasHiddenField' => true,
                'hiddenFieldName' => 'empNumber',
                'hiddenFieldId' => 'empNumber',
                'hiddenFieldValueGetter' => 'getEmpNumber',*/),
            ));
