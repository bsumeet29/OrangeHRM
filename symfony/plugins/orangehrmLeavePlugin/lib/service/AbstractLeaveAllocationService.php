...
//        $leaveRequest->setLeavePeriodId($leavePeriodId);
        ...
        $leaveRequest->setContactNo($leaveAssignmentData->getContactNo());
        $leaveRequest->setTask($leaveAssignmentData->getTask());
        $intEmp = $leaveAssignmentData->getAlternateContactPerson();
        $leaveRequest->setAlternateContactPerson($intEmp);   
        $leaveRequest->setContactPersons($leaveAssignmentData->getContactPersons());
        return $leaveRequest;
    }
    ...
    public function createLeaveObjectListForAppliedRange(LeaveParameterObject $leaveAssignmentData) {
        ...
        for ($timeStamp = $from; $timeStamp <= $to; $timeStamp = $this->incDate($timeStamp)) {
            ...
            $leave->setLeaveRequestDate(date('Y-m-d'));
