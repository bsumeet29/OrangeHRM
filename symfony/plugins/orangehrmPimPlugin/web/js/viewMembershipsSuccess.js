$(document).ready(function() {
    ...
    $('#frmEmpDelMemberships a').live('click', function() {
        ...
        var vehicle_type = row.find("td:nth-child(4)").text();
        var vehicle_number = row.find("td:nth-child(5)").text();
       ...
       // $('#membership_membership').val(memcode[1]);
        ...
        $('#membership_vehicle_type').val(type);
        $('#membership_vehicle_type').val(vehicle_type);
        $('#membership_vehicle_number').val(vehicle_number);
