$(document).ready(function() {
    ...
    $("#frmEmpImmigration").validate({
        rules: {
            ...
            'immigration[passport_issue_date]': { required: true,valid_date: function(){return {format:datepickerDateFormat, displayFormat:displayDateFormat}}},
            'immigration[passport_expire_date]' : { required: true,valid_date: function(){return {format:datepickerDateFormat,displayFormat:displayDateFormat}}, date_range: function() {return {format:datepickerDateFormat, displayFormat:displayDateFormat, fromDate:issuedDate}}},
            'immigration[i9_review_date]' : { required: true,valid_date: function(){return {format:datepickerDateFormat, displayFormat:displayDateFormat}}},
            'immigration[comments]': {required: true,maxlength: 250}
        },
        messages: {
            'immigration[number]': {required: lang_numberRequired},
            'immigration[passport_issue_date]': {required: lang_numberRequired,valid_date: lang_invalidDate},
            'immigration[passport_expire_date]' : {required: lang_numberRequired,valid_date: lang_invalidDate, date_range: lang_issuedGreaterExpiry},
            'immigration[i9_review_date]' : {required: lang_numberRequired,valid_date: lang_invalidDate},
            'immigration[comments]': {required: lang_numberRequired,maxlength: lang_commentLength}
        }
    });
