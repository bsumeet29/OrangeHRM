...
<div class="modal hide" id="deleteTerminationReasons">
  ...
  <div class="modal-footer">
    <input type="button" class="btn" data-dismiss="modal" id="dialogDeleteBtnTerminationReasons" value="<?php echo __('Ok'); ?>" />
    <input type="button" class="btn reset" data-dismiss="modal" id="cancelDeleteTerminationReasons" value="<?php echo __('Cancel'); ?>" />
  </div>
</div>
