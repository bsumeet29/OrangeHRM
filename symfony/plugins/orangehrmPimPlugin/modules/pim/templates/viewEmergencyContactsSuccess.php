                ...
                <fieldset>
                    <ol>
                        ...
                        <li>
                            ...
                            <?php echo $form['homePhone']->render(array("class" => "formInputText", "maxlength" => 15)); ?>
                        </li>
                        <li>
                            <?php echo $form['mobilePhone']->renderLabel(__('Mobile')); ?>
                            <?php echo $form['mobilePhone']->render(array("class" => "formInputText", "maxlength" => 10,'minlength'=>10)); ?>
                        </li>
                        <li>
                            <?php echo $form['workPhone']->renderLabel(__('Work Telephone')); ?>
                            <?php echo $form['workPhone']->render(array("class" => "formInputText", "maxlength" => 15)); ?>
                        </li>
                        <li class="required">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#frmEmpEmgContact").validate({
            ...
            rules: {
                'emgcontacts[name]' : {required:true, maxlength:100,regx:/^[A-Za-z_ ]{0,20}$/},
                'emgcontacts[relationship]' : {required: true, maxlength:100,regx:/^[A-Za-z_ ]{0,20}$/},
                'emgcontacts[homePhone]' : {phone: true, validContactPhone:true, maxlength:15},
                'emgcontacts[mobilePhone]' : {phone: true, maxlength:10,minlength:10},
                'emgcontacts[workPhone]' : {phone: true, maxlength:15}
            },
            messages: {
                'emgcontacts[name]': {
                ...
                'emgcontacts[homePhone]' : {
                    ...
                    maxlength: '<?php echo __(ValidationMessages::TEXT_LENGTH_EXCEEDS,array('%amount%' => 15)); ?>'
                },
