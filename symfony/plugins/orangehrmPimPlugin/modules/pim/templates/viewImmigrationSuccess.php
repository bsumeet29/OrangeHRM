...
<script type="text/javascript">
    ...
    var lang_editImmigrationHeading = "<?php echo __('Edit Identification Proof');?>";
    var lang_addImmigrationHeading = "<?php echo __('Add Identification Proof');?>";
...
<!--                        <li>
                        ...
                        <li>
                            ...
                            <?php echo $form['passport_expire_date']->render(array("class" => "formInputText","readonly"=>"readonly")); ?>
                        </li>
<!--                        <li>
...
<!--                        <li>
    ...
    <div class="miniList" id="immidrationList">
        <div class="head">
            <h1><?php echo __("Assigned Identification Proofs"); ?></h1>
        </div>
                                ...
                                <td class="document">
                                    ...
                                    switch ($record->type){
                                        ...
                                        case 3:
                                            ...
                                            break;
                                        case 4:
                                            $document='Election Identity Card';
                                            break;
                                        case 5:
                                            $document='PAN Card';
                                            break;
                                    ...
                                    if ($immigrationPermission->canUpdate()) { ?>
                                    <a href="#"><?php echo $document ; ?></a>
                                    <?php } else { ?>
                                    <?php echo $document; ?>
                                    <?php } ?>
