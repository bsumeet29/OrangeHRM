...
<div class="box pimPane">
    ...
    <?php if ($membershipPermissions->canCreate() || ($hasMemDetails && $membershipPermissions->canUpdate())) { ?>
        <div id="addPaneMembership">
            <div class="head">
                <h1 id="membershipHeading"><?php echo __('Add Mode Of Commutation'); ?></h1>
            </div>
            ...
            <div class="inner">
                <form name="frmEmpMembership" id="frmEmpMembership" method="post" 
                    ...
                    <fieldset>
                        <ol>
                            <li>
                                <?php echo $form['type']->renderLabel(__('Commutation Type') . ' <em>*</em>'); ?>
                                <?php echo $form['type']->render(array("class" => "drpDown", "maxlength" => 50)); ?>
                            </li>
                            <li>
                                <?php echo $form['vehicleType']->renderLabel(__('Vehicle Type')); ?>
                                <?php echo $form['vehicleType']->render(array("class" => "drpDown", "maxlength" => 50)); ?>
                            </li>
                            <li>
                                <?php echo $form['vehicleNumber']->renderLabel(__('Vehicle Number')); ?>
                                <?php echo $form['vehicleNumber']->render(array("class" => "formInputM", "maxlength" => 13)); ?>
                            </li>
    ...
    <div class="miniList" id="listMembershipDetails">
        <div class="head">
            <h1><?php echo __("Add Mode Of Commutation"); ?></h1>
        </div>
                    ...
                    <p id="listActions">
                        <?php if ($membershipPermissions->canCreate()) { ?>
                            ...
                            foreach ($membershipDetails as $memshipDetail) {
                                $savedMemship = $savedMemship . '' . $memshipDetail->getMembershipId() . '^';
                            }
                        } ?>
                    ...
                    <table id="" class="table hover">
                        <thead>
                            <tr>
                                ...
                                <?php } ?>
                                <th class="memshipCode"><?php echo __("Commutation Type");//echo __("Membership"); ?></th>
                                <th><?php echo __("Vehicle Type"); //echo __("Subscription Paid By"); ?></th>
                                <th class="memshipAmount"><?php echo __("Vehicle Number");//echo __("Subscription Amount"); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php } else { ?>    
                                ...
                                foreach ($membershipDetails as $memship) :
                                    ...
                                    <?php
                                    echo "<td class='memship' valigh='top'>" . $memship->type . '</td>';
                                    echo "<td  class='memshipAmount1' valigh='top'>" . $memship->vehicleType . '</td>';
                                    echo "<td class='memship'valigh='top'>" . $memship->vehicleNumber . '</td>';
                                    /*
...
<script type="text/javascript">
    ...
    var addMembershipDetail = '<?php echo __("Add Mode Of Commutation"); ?>';
    var editMembershipDetail = '<?php echo __("Edit Mode Of Commutation"); ?>';
    ...
    //]]>
     ...
     $("#frmEmpMembership").validate({
        ...
        messages: {
            'membership[type]':{required:'Select vehicle type.'},
            'membership[vehicleType]':{required:'Select vehicle type.'}
    ...
    $('#membership_type').change(function(){
        if($('#membership_type').val()=="Public"){
            $('#membership_vehicleType').attr("disabled", true);
            $('#membership_vehicleNumber').attr("disabled", true);
        }else{
            $('#membership_vehicleType').attr("disabled", false);
            $('#membership_vehicleNumber').attr("disabled", false);
        }
