...
<div class="modal hide" id="deleteAttachment">
  ...
  <div class="modal-footer">
    <input type="button" class="btn" data-dismiss="modal" id="dialogDeleteAttachment" value="<?php echo __('Ok'); ?>" />
    <input type="button" class="btn reset" data-dismiss="modal" id="cancelDeleteAttachment" value="<?php echo __('Cancel'); ?>" />
  </div>
</div>
...
<script type="text/javascript">
    ...
    var attachmentValidator =
        ...
        $('#btnDeleteAttachment').click(function() {
            ...
            $("#dialogDeleteAttachment").click(function(){
