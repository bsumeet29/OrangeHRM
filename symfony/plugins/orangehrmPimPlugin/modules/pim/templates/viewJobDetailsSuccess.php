...
<script type="text/javascript">
    ...
    var lang_startDateAfterJoinDate='<?php echo __('Start date should be after join date'); ?>';
    var lang_nextDateAfterJoinDate="<?php echo __('Next appraisal date should be after probation end date .'); ?>";
...
<div class="box pimPane" id="">
    ...
    <div class="">
        <div class="head">
            <h1><?php echo __('Employment Details'); ?></h1>
        </div> <!-- head -->
        ...
        <div class="inner">
            ...
            <form id="frmEmpJobDetails" method="post" enctype="multipart/form-data" action="<?php echo url_for('pim/viewJobDetails'); ?>">
                <fieldset>
                    ...
                    <ol>
                        <li class="hidefield" style="display:none">
                            <label><?php echo __("Employee Number"); ?></label>
                            <span id="jobDetailsEmployeeId"><label id="labelJobDetailsEmployeeId"> <?php echo $empNumber;?> </label></span>                          ;
                        </li>
                        
                        <li>
                            <?php echo $form['job_title']->renderLabel(__('Designation')); ?>
                            <?php echo $form['job_title']->render(array("class" => "formSelect")); ?>    
                        </li>
                        <!--li>
                            <?php #echo $form['workShift']->renderLabel(__('sd')); ?>
                            <?php #echo $workShift; ?>   
                        </li-->
<!--                        <li>
                        ...
                        <li>
                            <?php echo $form['eeo_category']->renderLabel(__('Department')); ?>
                            <?php echo $form['eeo_category']->render(array("class" => "formSelect")); ?>
                        </li>
                        <li>
                            <?php echo $form['joined_date']->renderLabel(__('Joined Date')); ?>
                            <?php echo $form['joined_date']->render(array("class" => "formDateInput","readonly"=>"readonly")); ?>
                        </li>
<!--                        <li>
                        ...
                        <li>
                            <h2><?php echo __('Probation Period'); ?></h2>
                        </li>
                      
                        <li>
                            <?php echo $form['contract_start_date']->renderLabel(__('Start Date')); ?>
                            <?php echo $form['contract_start_date']->render(array("class" => "formDateInput","readonly"=>"readonly")); ?>
                        </li>
                        <li>
                            <?php echo $form['contract_end_date']->renderLabel(__('End Date')); ?>
                            <?php echo $form['contract_end_date']->render(array("class" => "formDateInput","readonly"=>"readonly")); ?>
                        </li>
                         <li>
                            <?php echo $form['next_appraisal_date']->renderLabel(__('Next Appraisal Date')); ?>
                            <?php echo $form['next_appraisal_date']->render(array("class" => "formDateInput","readonly"=>"readonly")); ?>
                         </li>
                            <?php
            ...
            <fieldset>
                <ol>
                    ...
                    <li>
                        ...
                        <?php echo $employeeTerminateForm['date']->render(array("class" => "formDateInput","readonly"=>"readonly")); ?>
                    </li>
    ...
    $(document).ready(function() {
        ...
        $("#frmEmpJobDetails").validate({
            rules: {
                ...
                'job[contract_start_date]': { required: false, valid_date: function(){ return {format:datepickerDateFormat, required:false, displayFormat:displayDateFormat};},date_range: function() {return {format:datepickerDateFormat, displayFormat:displayDateFormat, fromDate:joinDate};}},
                ...
                'job[next_appraisal_date]' :{ required: false,
                    valid_date: function(){ return {format:datepickerDateFormat, required:false, displayFormat:displayDateFormat}; },
                    date_range: function() {return {format:datepickerDateFormat, displayFormat:displayDateFormat, fromDate:endDate};} }
            ...
            messages: {
                ...
                'job[contract_start_date]': { valid_date: lang_invalidDate,date_range:lang_startDateAfterJoinDate},
                'job[contract_end_date]': { valid_date: lang_invalidDate, date_range:lang_startDateAfterEndDate},
                'job[next_appraisal_date]' :{ valid_date: lang_invalidDate,date_range:lang_nextDateAfterJoinDate}
            }
        });
        ...
        '#job_contract_file,#job_next_appraisal_date');
        for(i=0; i < list.length; i++) {
            $(list[i]).attr("disabled", "disabled");
        }
        
        $('#job_joined_date,#job_contract_start_date,#job_contract_end_date,#job_next_appraisal_date').datepicker('disable');
        ...
        $("#btnSave").click(function() {
            ...
            if ( !readonlyFlag) {  
                ...
                if($("#btnSave").attr('value') == edit) {
                    ...
                    $('#job_joined_date,#job_contract_start_date,#job_contract_end_date,#job_next_appraisal_date').datepicker('enable');
                ...
                if($("#btnSave").attr('value') == save) {
                    ...
                    joinDate = $('#job_joined_date').val();
                    endDate =$('#job_contract_end_date').val();
