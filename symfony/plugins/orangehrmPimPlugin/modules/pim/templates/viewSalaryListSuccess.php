        ...
        <div class="inner">
            <form id="frmSalary" action="<?php echo url_for('pim/viewSalaryList?empNumber=' . $empNumber); ?>" method="post" class="longLabels">
                <fieldset>
                    ...
                    <?php echo $form['employee_id']->render(); ?>
                    <ol>
                      
                        <li>
                            <?php echo $form['payment_mode']->renderLabel(__('Payment Mode')); ?>
                            <?php echo $form['payment_mode']->render(array("class" => "formInputText", "maxlength" => 100)); ?>
                        </li>
 <!--                   <li>
...
-->
                        <li>
                            ...
                            <?php echo $form['basic_salary']->renderLabel(__('CTC') . ' <em>*</em>'); ?>
...
-->
                    ...
                    <ol id="directDebitSection">
                        ...
                        <li>
                            ...
                            <?php echo $directDepositForm['account']->render(array("class" => "formInputText", "maxlength" => 16)); ?>
                        </li>
                        
                        <li>
                            <?php echo $directDepositForm['nominee_name']->renderLabel(__('Nominee Name') . ' <em>*</em>'); ?>
                            <?php echo $directDepositForm['nominee_name']->render(array("class" => "formInputText")); ?>
                        </li>
                        
                        <li>
                            <?php echo $directDepositForm['pf_number']->renderLabel(__('PF Number')); ?>
                            <?php echo $directDepositForm['pf_number']->render(array("class" => "formInputText", "maxlength" => 25)); ?>
                        </li>
                        
                        <li>
                            <?php echo $directDepositForm['nominee_name_pf']->renderLabel(__(' Nominee name (PF a/c)') . ' <em>*</em>'); ?>
                            <?php echo $directDepositForm['nominee_name_pf']->render(array("class" => "formInputText")); ?>
                        </li>
...
-->
                        <li> 
                            <?php echo $directDepositForm['routing_num']->renderLabel(__('IFSC code') . ' <em>*</em>'); ?>
                            <?php echo $directDepositForm['routing_num']->render(array("class" => "formInputText", "maxlength" => 16)); ?>
                        </li>
                        <li>
                            <?php echo $directDepositForm['branch_name']->renderLabel(__('Branch Name') . ' <em>*</em>'); ?>
                            <?php echo $directDepositForm['branch_name']->render(array("class" => "formInputText", "maxlength" => 100)); ?>
                        </li>
<!--                        <li>
    ...
    <div class="miniList" id="salaryMiniList">
        ...
        <div class="inner">
            ...
            <form id="frmDelSalary" action="<?php echo url_for('pim/deleteSalary?empNumber=' . $empNumber); ?>" method="post" class="longLabels">
                <?php echo $listForm ?>
                <p id="actionSalary">
                    <?php if ($salaryPermissions->canCreate() && count($salaryList) == 0 ) { ?>
                ...
                <table id="tblSalary" class="table hover">
                    <thead>
                        <tr>
                            ...
                            <!--<th class="check" style="width:2%"><input type="hidden" id="salaryCheckAll" /></th>-->
                            <?php } ?>
                            <th class="component"><?php echo __('Payment mode'); ?></th>
<!--                            <th class="payperiod"><?php echo __('Pay Frequency'); ?></th>-->
<!--                            <th class="currency"><?php echo __('Currency'); ?></th>-->
                            <th class="amount"><?php echo __('CTC'); ?></th>
...
<!--                                <td class="check">
                                    <input type="hidden" class="chkbox" value="<?php echo $salary->id; ?>" name="delSalary[]"/>
                                </td>-->
                                <?php } ?>
                                <td class="component">
                                    <input type="hidden" class="chkbox" value="<?php echo $salary->id; ?>" name="delSalary[]"/>
                                    <input type="hidden" id="code_<?php echo $salary->id; ?>" value="<?php echo $salary->id; ?>" />                                      <?php if($salaryPermissions->canUpdate()) {?>
                                    <a href="#" class="edit"><?php echo ($component=='hdfc')?"HDFC":"Cheque";?></a>
                                    <?php }else{ 
                                    echo ($component=='hdfc')?"HDFC":"Cheque";
                                    }?>
                                </td>
...
<!--                                <td class="comments"><?php echo $comments; ?></td>-->
                                <td>
                                    ...
                                    <input type="hidden" id="dd_nominee_name_<?php echo $salary->id; ?>" value="<?php echo $directDeposit->nominee_name; ?>" />
                                    <input type="hidden" id="dd_pf_no_<?php echo $salary->id; ?>" value="<?php echo $directDeposit->pf_number; ?>" />
                                    <input type="hidden" id="dd_nominee_name_pfno_<?php echo $salary->id; ?>" value="<?php echo $directDeposit->nominee_name_pf;  ?>" />
                                    <input type="hidden" id="dd_routing_num_<?php echo $salary->id; ?>" value="<?php echo $directDeposit->routing_num; ?>" />
                                    <input type="hidden" id="dd_brach_<?php echo $salary->id; ?>" value="<?php echo $directDeposit->branch_name; ?>" />
                                    <?php } ?>
                                        ...
                                        <table class="table hover" style="width:60%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo __("Nominee Name"); ?></th>
                                                    <th><?php echo __("PF Number"); ?></th>
                                                    <th><?php echo __("Nominee name (PF a/c)"); ?></th>
                                                    <th><?php echo __("IFSC code"); ?></th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $directDeposit->nominee_name; ?></td>
                                                    <td><?php echo $directDeposit->pf_number; ?></td>
                                                    <td><?php echo $directDeposit->nominee_name_pf; ?></td>
                                                    <td><?php echo $directDeposit->routing_num; ?></td>
                                                    <td><?php echo $directDeposit->branch_name; ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
...
//<![CDATA[
    ...
    var getLatestEmployeeIdURL = '<?php echo url_for('pim/getLatestEmployeeIdAjax'); ?>';
//]]>
</script>
...
//<![CDATA[
    ...
    function clearDirectDepositFields() {
        ...
        $("#directdeposit_nominee_name").val('');
        $("#directdeposit_pf_number").val('');
        $("#directdeposit_nominee_name_pf").val('');
        $("#directdeposit_routing_num").val('');
        $("#directdeposit_branch_name").val('');
    }
    ...
    */
    $("#addSalary").click(function() {
      ...
      //  $("#salary_comments").val("");
        ...
        if($('#salary_payment_mode').val() == 'hdfc'){
    ...
    var salaryValidator =
        ...
        rules: {
            ...
            'directdeposit[account]': {required: "#salary_set_direct_debit:checked", maxlength:16,
                regx: /^[a-zA-Z0-9]*$/
            },
            'directdeposit[nominee_name]':{required: true},
            'directdeposit[pf_number]':{regx: /^[a-zA-Z0-9]*$/,maxlength:25},
            'directdeposit[nominee_name_pf]':{required: true},
            'directdeposit[branch_name]':{required: true},
...
//                },
//                maxlength:20},
            'directdeposit[routing_num]': {required: "#salary_set_direct_debit:checked",regx: /^[a-zA-Z0-9]*$/,maxlength:16},
//            'directdeposit[amount]': {required: "#salary_set_direct_debit:checked", number:true, min: 0, max:1000000000.00}
        ...
        messages: {
            ...
            'directdeposit[account]': {required: lang_accountRequired, maxlength: lang_accountMaxLength,
             regx :'Please enter valid account number.'
            },
            'directdeposit[nominee_name]':{required: lang_accountRequired},
            'directdeposit[pf_number]':{regx :'Please enter valid PF number.'},
            'directdeposit[nominee_name_pf]':{required: lang_accountRequired},
            'directdeposit[branch_name]':{required: lang_accountRequired},
...
//            'directdeposit[account_type_other]': {required: lang_otherRequired, maxlength: lang_otherMaxLength},
            'directdeposit[routing_num]': {required: lang_routingNumRequired,regx :'Please enter valid IFSC code number.'},
...
//        $("#salary_comments").val(comments);
        ...
        if (haveDirectDeposit) {
            ...
            $("#directdeposit_nominee_name").val($("#dd_nominee_name_" + id).val());
            $("#directdeposit_pf_number").val($("#dd_pf_no_" + id).val());
            $("#directdeposit_nominee_name_pf").val($("#dd_nominee_name_pfno_" + id).val());
            $("#directdeposit_routing_num").val($("#dd_routing_num_" + id).val());
            $("#directdeposit_branch_name").val($("#dd_brach_" + id).val());
            $('#directDebitSection').show();
            $('#notDirectDebitSection').hide();
...
//            }
    ...
    */
    $('#salary_payment_mode').change(function(){
        if($('#salary_payment_mode').val()){
            paymentmode=$('#salary_payment_mode').val();
            if(paymentmode == 'hdfc'){
                 $("#salary_set_direct_debit").attr('checked', 'checked');
                 $('#directDebitSection').show();
                 $('#notDirectDebitSection').hide();
           ...
           // alert(paymentmode);
            ...
            success: function(data) {
              // alert(data);
               $('#salary_employee_id').attr('value','P'+data);
            }
            });
