        ...
        <div class="inner">
            ...
            <form id="frmEmpContactDetails" method="post" action="<?php echo url_for('pim/contactDetails'); ?>">
                ...
                <fieldset>
                    ...
                    <ol>
                        <li>
                              <h2><?php echo __('Current Address'); ?></h2>
                            <?php //echo $form['current_address']->render(array()); ?>
                        </li>
                        <li>
                    ...
                    <ol>
                        <li>
                              <h2><?php echo __('Permanent Address'); ?></h2>
                            <?php //echo $form['permanent_address']->render(array()); ?>
                        </li>
                        <li>
                             <?php echo $form['permanent_street1']->renderLabel(__("Same as current address")); ?>
                             <?php echo $form['checkbox']->render(array("class" => "formInputText")); ?>
                        </li>
                        </li>
                        <li>
                            <?php echo $form['permanent_street1']->renderLabel(__("Address Street 1")); ?>
                            <?php echo $form['permanent_street1']->render(array("class" => "formInputText", "maxlength" => 70)); ?>
                        </li>
                        <li>
                            <?php echo $form['permanent_street2']->renderLabel(__("Address Street 2")); ?>
                            <?php echo $form['permanent_street2']->render(array("class" => "formInputText", "maxlength" => 70)); ?>
                        </li>
                        <li>
                            <?php echo $form['permanent_city']->renderLabel(__("City")); ?>
                            <?php echo $form['permanent_city']->render(array("class" => "formInputText", "maxlength" => 70)); ?>
                        </li>
                        <li>
                            <?php echo $form['permanent_province']->renderLabel(__("State/Province")); ?>
                            <?php echo $form['permanent_province']->render(array("class" => "formInputText", "maxlength" => 70)); ?>
                            
                        </li>
                        <li>
                            <?php echo $form['permanent_emp_zipcode']->renderLabel(__("Zip/Postal Code")); ?>
                            <?php echo $form['permanent_emp_zipcode']->render(array("class" => "formInputText", "maxlength" => 10)); ?>
                        </li>
                        <li>
                            <?php echo $form['permanent_country']->renderLabel(__("Country")); ?>
                            <?php echo $form['permanent_country']->render(array("class" => "formInputText")); ?>
                        </li> 
                    ...
                    <ol>
                        <li>
                            ...
                            <?php echo $form['emp_hm_telephone']->render(array("class" => "formInputText", "maxlength" => 21)); ?>
                        </li>
                        <li>
                            <?php echo $form['emp_mobile']->renderLabel(__("Mobile")); ?>
                            <?php echo $form['emp_mobile']->render(array("class" => "formInputText", "maxlength" => 10,'minlength'=>10)); ?>
                        </li>
                        <li>
                            <?php echo $form['emp_work_telephone']->renderLabel(__("Work Telephone")); ?>
                            <?php echo $form['emp_work_telephone']->render(array("class" => "formInputText", "maxlength" => 21)); ?>
                        </li>
                    </ol>
                    <ol>
                        <li>
                            <?php echo $form['emp_work_email']->renderLabel(__("Work Email")); ?>
                            <?php echo $form['emp_work_email']->render(array("class" => "formInputText", "maxlength" => 50,"readonly"=>"readonly")); ?>
                        </li>
                        <li>
