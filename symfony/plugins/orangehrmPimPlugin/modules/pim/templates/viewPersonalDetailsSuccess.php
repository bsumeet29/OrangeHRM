        ...
        <div class="inner">
            ...
            <form id="frmEmpPersonalDetails" method="post" action="<?php echo url_for('pim/viewPersonalDetails'); ?>">
                ...
                <fieldset>
                        ...
                        <li class="line nameContainer">
                            ...
                            <ol class="fieldsInLine">
                                <li>
                                    ...
                                    <?php echo $form['txtEmpFirstName']->render(array("class" => "block default editable", "maxlength" => 20, "title" => __('First Name'))); ?>
                                </li>
                                <li>
                                    <div class="fieldDescription"><?php echo __('Middle Name'); ?></div>
                                    <?php echo $form['txtEmpMiddleName']->render(array("class" => "block default editable", "maxlength" => 20, "title" => __('Middle Name'))); ?>
                                </li>
                                <li>
                                    <div class="fieldDescription"><em>*</em> <?php echo __('Last Name'); ?></div>
                                    <?php echo $form['txtEmpLastName']->render(array("class" => "block default editable", "maxlength" => 20, "title" => __('Last Name'))); ?>
                                </li>  
                    ...
                    <ol>
                        <li class="line">   
                           <label for="" class=""><?php echo __('Mother\'s Name'); ?></label>
                           <?php echo $form['txtMothersName']->render(array("class" => "block default editable", "maxlength" => 20, "title" => __('Mothers Name'))); ?>
                        </li>
                        <li class="long">
                            <label for=""><?php echo __('Employee Id'); ?></label>
                            <?php echo $form['txtEmployeeId']->render(array("maxlength" => 10, "class" => "editable","readonly"=>"readonly")); ?>
                        </li>
                        
<!--                        <li>
                            <label for=""><?php echo __('PF Number'); ?></label>
                            <?php echo $form['txtPfNumber']->render(array("class" => "block default editable", "maxlength" => 30, "title" => __('PF Number'))); ?>
                        </li>
                        <li>
                            <label for=""><?php echo __("Driver's License Number"); ?></label>
                            <?php echo $form['txtLicenNo']->render(array("maxlength" => 30, "class" => "editable")); ?>
                        </li>
                        <li>
                            <label for=""><?php echo __('License Expiry Date'); ?></label>
                            <?php echo $form['txtLicExpDate']->render(array("class"=>"calendar editable","readonly"=>"readonly")); ?>
                        </li>
-->
                        
                        <?php if ($showSSN) : ?>
                        <li class="new">
                            <label for=""><?php echo __('SSN Number'); ?></label>
                            <?php echo $form['txtNICNo']->render(array("class" => "editable", "maxlength" => 30)); ?>
                        </li>                    
                        <?php endif; ?>
                        <?php if ($showSIN) : ?>
                        <li class="<?php echo !($showSSN)?'new':''; ?>">
                            <label for=""><?php echo __('SIN Number'); ?></label>
                    ...
                    <ol>
                        <li class="radio">
                            <label for=""><?php echo __("Gender"); ?></label>
                            <?php echo $form['optGender']->render(array("class"=>"editable","for"=>"")); ?>
                        </li>
                        <li>              
                            <label for="" class=""><?php echo __('Blood Group'); ?></label>
                             <?php echo $form['cmbBloodGroup']->render(array("class" => "block default editable", "maxlength" => 10, "title" => __('Blood Group'))); ?>
                         </li>
                        <li class="new">
                            <label for=""><?php echo __("Nationality"); ?></label>
                            <?php echo $form['cmbNation']->render(array("class"=>"editable")); ?>
                        </li>
                        <li>
                            <label for=""><?php echo __("Date of Birth"); ?></label>
                            <?php echo $form['DOB']->render(array("class"=>"editable","readonly"=>"readonly")); ?>
                        </li>
                        <li>
                            <label for=""><?php echo __('Marital Status'); ?></label>
                            <?php echo $form['cmbMarital']->render(array("class"=>"editable")); ?>
                        </li>
                        <li class="anniversary">
                            <label for=""><?php echo __('Anniversary Date'); ?></label>
                            <?php echo $form['txtAnniversaryDate']->render(array("class"=>"editable","readonly"=>"readonly")); ?>
                        </li>
