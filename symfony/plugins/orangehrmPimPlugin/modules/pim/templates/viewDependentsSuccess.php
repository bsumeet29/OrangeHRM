                ...
                <fieldset>
                    <ol>
                        ...
                        <li>
                            ...
                            <?php echo $form['dateOfBirth']->render(array("class" => "formDateInput","readonly"=>"readonly")); ?>    
                        </li>
                        <li class="required">
...
<script type="text/javascript">
    ...
    function hideShowRelationshipOther() {
        if ($('#dependent_relationshipType').val() == 'other') {
    ...
    $(document).ready(function() {
        ...
        $("#frmEmpDependent").validate({
            ...
            rules: {
                'dependent[name]' : {required:true, maxlength:100,regx:/^[A-Za-z_ ]{0,20}$/},
