...
class saveDeleteWorkExperienceAction extends basePimAction {
    ...
    private function getWorkExperience(sfForm $form) {
       ...
       // $workExperience->comments = $post['comments'];
        $workExperience->last_appraisal_date=$post['last_appraisal_date'];
        $workExperience->ctc_previous=$post['previous_ctc'];
        $workExperience->relevant_experience=$post['relevant_exp'];
        $workExperience->total_experience=$post['total_exp'];
