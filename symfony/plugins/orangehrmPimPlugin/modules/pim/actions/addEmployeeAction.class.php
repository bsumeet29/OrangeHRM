...
class addEmployeeAction extends basePimAction {
    ...
    public function execute($request) {
        ...
        $request->setParameter('initialActionName', 'addEmployee');
        ...
        if ($allowedToAddEmployee) {
            ...
            if ($request->isMethod('post')) {
                ...
                //check username is valid format or not
                
                $this->_validateEmailAddress($posts['user_name']);
                ...
                if ($this->createUserAccount) {
                    ...
                    if($user instanceof SystemUser) {
                        ...
                        $this->getUser()->setFlash('warning', __('Failed To Save: Email address already exists'));
                        $this->redirect('pim/addEmployee');
                    }
                }
    ...
    protected function _validateEmailAddress($emailAddress) {
