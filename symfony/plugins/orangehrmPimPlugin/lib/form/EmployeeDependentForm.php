...
class EmployeeDependentForm extends BaseForm {
    ...
    public function getDependentWidgets(){
        ...
        $relationshipChoices = array(
                    '' => "-- " . __('Select') . " --",
                    'Child'=> $i18nHelper->__('Child'), 
                    'Father'=> $i18nHelper->__('Father'), 
                    'Mother'=> $i18nHelper->__('Mother'), 
                    'Husband'=> $i18nHelper->__('Husband'), 
                    'Wife'=> $i18nHelper->__('Wife'), 
                    'Sister'=> $i18nHelper->__('Sister'), 
                    'Brother'=> $i18nHelper->__('Brother'), 
                    'other'=> $i18nHelper->__('Other'));
        ...
        $widgets['dateOfBirth'] = new ohrmWidgetDatePicker(array(), array('id' => 'dependent_dateOfBirth','maxDate'=>$today));
