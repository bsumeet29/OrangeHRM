...
class EmployeeEmergencyContactForm extends BaseForm {
    ...
    public function getEmergencyContactValidators(){
        $validators = array(
            ...
            'relationship' => new sfValidatorString(array('required' => true,'trim'=>true)),
            'homePhone' => new sfValidatorString(array('required' => false,'trim'=>true,'max_length'=>15)),
            'mobilePhone' => new sfValidatorString(array('required' => false,'trim'=>true,'max_length'=>10,'min_length'=>10)),
            'workPhone' => new sfValidatorString(array('required' => false,'trim'=>true,'max_length'=>15))
        );
