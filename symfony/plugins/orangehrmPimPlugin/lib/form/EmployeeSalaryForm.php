...
class EmployeeSalaryForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->payment_mode=$employee->getPaymentMode();
    ...
    public function getSalaryWidgets() {
       ...
       $paymentMode=array(
        ...
        $widgets['employee_id']=new sfWidgetFormInputHidden();
        $widgets['payment_mode']=new sfWidgetFormSelect(array('choices' =>$paymentMode));
        ...
        $widgets['employee_id']->setDefault($this->employee_id);
        $widgets['payment_mode']->setDefault($this->payment_mode);
    ...
    public function getSalaryValidators() {
        ...
        $validators = array(
            ...
            'employee_id' => new sfValidatorString(array('required' => false,)),
            'payment_mode' => new sfValidatorChoice(array('required' => false, 'choices' => array_keys($paymentMode))),
            'currency_id' => new sfValidatorChoice(array('required' => false, 'choices' => array_keys($this->currencies))),
...
//        }
    ...
    public function getSalary() {
        ...
        $empSalary->setSalaryName($this->getValue('payment_mode'));
    ...
    public function getEmployee(){
        ...
        $employee->employeeId = $this->getValue('employee_id');
        $employee->payment_mode=$this->getValue('payment_mode');
        return $employee;
    }
