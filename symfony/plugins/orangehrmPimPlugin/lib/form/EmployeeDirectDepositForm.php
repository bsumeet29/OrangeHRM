...
class EmployeeDirectDepositForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'nominee_name'=>new sfWidgetFormInputText(),
            'pf_number'=>new sfWidgetFormInputText(),
            'nominee_name_pf'=>new sfWidgetFormInputText(),
        ...
        $this->setValidators(array(
            ...
            'account' => new sfValidatorString(array('required' => true)),
            'nominee_name' => new sfValidatorString(array('required' => true)),
            'pf_number' => new sfValidatorString(array('required' => false)),
            'nominee_name_pf' => new sfValidatorString(array('required' => true)),
            'account_type' => new sfValidatorChoice(array('required' => false, 'choices' => array_keys($this->accountTypes))),
            'account_type_other' => new sfValidatorString(array('required' => false)), // only required if account_type = 'OTHER'.
            'routing_num' => new sfValidatorString(array('required' => true, 'trim'=>true, )),
            'branch_name' => new sfValidatorString(array('required' => true)),
...
//        }
    ...
    public function getDirectDeposit(&$salary) {
        ...
        $salary->directDebit->nominee_name   = $this->getValue('nominee_name');
        $salary->directDebit->pf_number      = $this->getValue('pf_number');
        $salary->directDebit->nominee_name_pf= $this->getValue('nominee_name_pf');
        $salary->directDebit->branch_name    = $this->getValue('branch_name');
