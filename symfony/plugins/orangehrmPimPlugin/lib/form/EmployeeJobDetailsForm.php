...
class EmployeeJobDetailsForm extends BaseForm {
    ...
    public function configure() {
        ...
        $workShift = $this->getOption('workShift');
...
//            'probation_period'=>new sfWidgetFormSelect(array('choices' => $probation_peroid)), 
            ...
            'next_appraisal_date' => new ohrmWidgetDatePicker(array(), array('id' => 'job_next_appraisal_date')),
            'workShift' => new sfWidgetFormInputHidden(),
        ));

        // Default values
        $this->setDefault('emp_number', $empNumber);
        $this->setDefault('emp_status', $employee->emp_status);
        $this->setDefault('workShift', $workShift);
        ...
        $this->setDefault('next_appraisal_date', set_datepicker_date_format($employee->next_appraisal_date));
        ...
        $this->setValidators(array(
            ...
            'joined_date' => new ohrmDateValidator(
                    array('date_format' => $inputDatePattern, 'required' => false),
                    array('invalid' => 'Date format should be ' . $inputDatePattern)),
//            'probation_period' => new sfValidatorString(array('required' => false)),
            ...
            'next_appraisal_date' => new ohrmDateValidator(
                    array('date_format' => $inputDatePattern, 'required' => false),
                    array('invalid' => 'Date format should be ' . $inputDatePattern)),
            'workShift' => new sfValidatorString(array('required' => false)),
        ));
    ...
    public function getEmployee() {
        ...
        $employee->next_appraisal_date = $this->getValue('next_appraisal_date');
