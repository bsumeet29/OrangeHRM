...
class EmployeeEducationForm extends sfForm {
    ...
    private function getEducationWidgets() {
        ...
        $widgets = array(
            ...
            'start_date' => new ohrmWidgetDatePicker(array(), array('id' => 'education_start_date','readonly' => 'readonly','maxDate'=>$today)),
            'end_date' => new ohrmWidgetDatePicker(array(), array('id' => 'education_end_date','readonly' => 'readonly','maxDate'=>$today))
        );
        return $widgets;
    }
