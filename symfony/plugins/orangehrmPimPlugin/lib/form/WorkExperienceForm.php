...
class WorkExperienceForm extends sfForm {
    ...
    public function getWorkExperienceWidgets() {
        ...
        $widgets['from_date'] = new ohrmWidgetDatePicker(array(), array('id' => 'experience_from_date','maxDate'=>$today));
        $widgets['to_date'] = new ohrmWidgetDatePicker(array(), array('id' => 'experience_to_date','maxDate'=>$today));
        $widgets['comments'] = new sfWidgetFormTextarea();
        $widgets['last_appraisal_date'] = new ohrmWidgetDatePicker(array(), array('id' => 'experience_last_appraisal_date','maxDate'=>$today));
        $widgets['previous_ctc'] = new sfWidgetFormInputText();
        $widgets['total_exp'] = new sfWidgetFormInputText();
        $widgets['relevant_exp'] = new sfWidgetFormInputText();
        return $widgets;
    }
    ...
    public function getWorkExperienceValidators() {
        ...
        $validators = array(
            ...
            'employer' => new sfValidatorString(array('required' => false, 'max_length' => 100,'trim'=>true)),
            'jobtitle' => new sfValidatorString(array('required' => false, 'max_length' => 120,'trim'=>true)),
            ...
            'last_appraisal_date' => new ohrmDateValidator(array('date_format' => $inputDatePattern, 'required' => false), array('required' => 'Date field is required', 'invalid' => 'Date format should be ' . $inputDatePattern)),
            'previous_ctc' => new sfValidatorNumber(array('required' => false)),
            'total_exp' =>  new sfValidatorNumber(array('required' => false)),
            'relevant_exp' => new sfValidatorNumber(array('required' => false)),
