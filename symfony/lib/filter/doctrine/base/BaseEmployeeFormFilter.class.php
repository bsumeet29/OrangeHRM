...
abstract class BaseEmployeeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mothersName'           => new sfWidgetFormFilterInput(),
      'bloodGroup'            => new sfWidgetFormFilterInput(),
      'pfNumber'              => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'mothersName'           => new sfValidatorPass(array('required' => false)),      
      'bloodGroup'            => new sfValidatorPass(array('required' => false)),
	  'pfNumber'  	          => new sfValidatorPass(array('required' => false)),
