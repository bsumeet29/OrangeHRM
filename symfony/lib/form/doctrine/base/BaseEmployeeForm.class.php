...
abstract class BaseEmployeeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mothersName'           => new sfWidgetFormInputText(),
      'bloodGroup'            => new sfWidgetFormInputText(),
      'pfNumber'              => new sfWidgetFormInputText(),  
    ...
    $this->setValidators(array(
      ...
      'bloodGroup'            => new sfValidatorString(array('required' => false)),
      'pfNumber'              => new sfValidatorString(array('required' => false)),
