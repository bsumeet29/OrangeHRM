 ...
 * @method string             getVehicleType()              Returns the current record's "vehicleType" value
 * @method string             getVehicleNumber()            Returns the current record's "vehicleNumber" value
 ...
 * @method EmployeeMembership setType()                     Sets the current record's "type" value
 * @method EmployeeMembership setVehicleType()              Sets the current record's "vehicleType" value
 * @method EmployeeMembership setVehicleNumber()            Sets the current record's "vehicleNumber" value
...
abstract class BaseEmployeeMembership extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('membship_code as membershipId', 'integer', 6, array(
             'type' => 'integer',
             'primary' => true,
             'length' => 6,
             ));
        ...
        $this->hasColumn('type as type', 'string', 25, array(
             'type' => 'string',
             'length' => 25,
             ));
        $this->hasColumn('vehicle_type as vehicleType', 'string', 25, array(
             'type' => 'string',
             'length' => 25,
             ));
        $this->hasColumn('vehicle_number as vehicleNumber', 'string', 25, array(
             'type' => 'string',
             'length' => 25,
             ));
    }
