...
abstract class BaseEmployeeSalary extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('ebsal_basic_salary as amount', 'string', 6, array(
             'type' => 'string',
             'notnull' => false,
             'length' => 6,
             ));
        $this->hasColumn('payperiod_code as payPeriodId', 'string', 6, array(
             'type' => 'string',
             'notnull' => false,
             'length' => 6,
             ));
        $this->hasColumn('salary_component as salaryName', 'string', 6, array(
             'type' => 'string',
             'notnull' => false,
             'length' => 6,
             ));
        $this->hasColumn('comments as notes', 'string', 6, array(
             'type' => 'string',
             'notnull' => false,
             'length' => 6,
             ));
