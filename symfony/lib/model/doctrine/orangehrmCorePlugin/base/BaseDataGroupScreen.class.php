 ...
 * @method DataGroupScreen setId()            Sets the current record's "id" value
 * @method DataGroupScreen setDataGroupId()   Sets the current record's "data_group_id" value
 * @method DataGroupScreen setScreenId()      Sets the current record's "screen_id" value
 * @method DataGroupScreen setPermission()    Sets the current record's "permission" value
 * @method DataGroupScreen setDataGroup()     Sets the current record's "DataGroup" value
 * @method DataGroupScreen setScreen()        Sets the current record's "Screen" value
 * 
 * @package    orangehrm
 ...
 */
abstract class BaseDataGroupScreen extends sfDoctrineRecord
{
