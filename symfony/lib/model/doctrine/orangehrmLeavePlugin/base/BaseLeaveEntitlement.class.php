 ...
 * @property Doctrine_Collection $CompoffExtensionRequest
 * 
 ...
 * @method Doctrine_Collection  getCompoffExtensionRequest() Returns the current record's "CompoffExtensionRequest" collection
 ...
 * @method LeaveEntitlement     setCompoffExtensionRequest() Sets the current record's "CompoffExtensionRequest" collection
 * 
 * @package    orangehrm
...
abstract class BaseLeaveEntitlement extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('CompoffExtensionRequest', array(
             'local' => 'id',
