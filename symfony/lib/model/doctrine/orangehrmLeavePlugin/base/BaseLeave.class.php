 ...
 * @property date $leave_request_date
 ...
 * @property Doctrine_Collection $LeaveConditions
 * 
 ...
 * @method date                getLeaveRequestDate()   Returns the current record's "leave_request_date" value
 ...
 * @method Doctrine_Collection getLeaveConditions()    Returns the current record's "LeaveConditions" collection
 ...
 * @method Leave               setLeaveRequestDate()   Sets the current record's "leave_request_date" value
 ...
 * @method Leave               setLeaveConditions()    Sets the current record's "LeaveConditions" collection
 * 
 * @package    orangehrm
...
abstract class BaseLeave extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('leave_request_date', 'date', 25, array(
             'type' => 'date',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
    ...
    public function setUp()
    {
        ...
        $this->hasMany('LeaveConditions', array(
             'local' => 'id',
             'foreign' => 'leave_id'));
    }
}