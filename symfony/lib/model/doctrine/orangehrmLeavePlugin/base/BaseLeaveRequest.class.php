 ...
 * @property Doctrine_Collection $LeaveRequestConditions
 * 
 ...
 * @method Doctrine_Collection getLeaveRequestConditions() Returns the current record's "LeaveRequestConditions" collection
 ...
 * @method LeaveRequest        setContactNo()              Sets the current record's "contact_no" value
 ...
 * @method LeaveRequest        setLeaveTasks()             Sets the current record's "LeaveTasks" collection
 * @method LeaveRequest        setLeaveRequestConditions() Sets the current record's "LeaveRequestConditions" collection
 * 
 * @package    orangehrm
...
abstract class BaseLeaveRequest extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('LeaveRequestConditions', array(
             'local' => 'id',
             'foreign' => 'leave_request_id'));
    }
}