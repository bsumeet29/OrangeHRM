 ...
 * @property date $last_appraisal_date
 * @property decimal $ctc_previous
 * @property decimal $relevant_experience
 ...
 * @method date              getLastAppraisalDate()   Returns the current record's "last_appraisal_date" value
 * @method decimal           getCtcPrevious()         Returns the current record's "ctc_previous" value
 * @method decimal           getRelevantExperience()  Returns the current record's "relevant_experience" value
 ...
 * @method EmpWorkExperience setLastAppraisalDate()   Sets the current record's "last_appraisal_date" value
 * @method EmpWorkExperience setCtcPrevious()         Sets the current record's "ctc_previous" value
 * @method EmpWorkExperience setRelevantExperience()  Sets the current record's "relevant_experience" value
 * @method EmpWorkExperience setTotalExperience()     Sets the current record's "total_experience" value
...
abstract class BaseEmpWorkExperience extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('last_appraisal_date', 'date', 25, array(
             'type' => 'date',
             'length' => 25,
             ));
        $this->hasColumn('ctc_previous', 'decimal', 10, array(
             'type' => 'decimal',
             'length' => 10,
             ));
        $this->hasColumn('relevant_experience', 'decimal', 5, array(
             'type' => 'decimal',
             'length' => 5,
             ));
        $this->hasColumn('total_experience', 'decimal', 5, array(
             'type' => 'decimal',
             'length' => 5,
             ));
    }
